        ...
        <section className="about">
            <div className="container">
                ...
                <div className="text">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam animi explicabo ducimus reprehenderit quasi perferendis voluptas blanditiis, voluptate debitis exercitationem magnam libero sequi. Nihil ut mollitia velit repellendus labore inventore?</p>
                    <p>Accumsan at augue mi at vitae in Accumsan at augue </p>
                </div>
            </div>
        </section>
